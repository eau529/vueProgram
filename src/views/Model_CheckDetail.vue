<template>
	...
	<div class="">
		...
		<div class="container" style="position:relative">
			<el-tabs v-model="message" @tab-click="handleClick" @click="initTempCheck">
				<!-- click操作不能在组件上，要在div里-->
				<!-- <div @click="selectIndex=true"> -->
				<el-tab-pane :label="`校验报告`" name="first" style="margin-top: 10px">

					<el-form :inline="true" :model="filters">

						<el-form-item>
							<p style="font-size:25px;font-weight: bold;">{{temp.name}}</p>
						</el-form-item>

						<el-form-item>
							<!-- 查看版本详情弹出框 -->
							<el-popover v-model:visible="visible" placement="right" :width="600"
								...
								<template #reference style="margin-left:20px;">
									...
									<el-button style="float: left;font-size:20px;font-weight: bold;color:silver"
										type="text" plain @click="doFilter">&#8197;模型版本{{temp.zip}}</el-button>
								</template>

							</el-popover>
						</el-form-item>
						<el-form-item>
							<p style="font-size:15px;margin-left:10px">训练时间:{{temp.date}}</p>
						</el-form-item>



					</el-form>
					<el-popover v-model:visible="visible" placement="right" :width="600" style="float: left">

						<el-descriptions :data="PopovereData" class="margin-left" title="模型分析" :column="1"
							style="margin-left:20px;">
							<el-descriptions-item label="分析内容:">{{temp.name}}</el-descriptions-item>
						</el-descriptions>

						<template #reference style="float: left;">
							<el-button style="float: left;font-size:20px;font-weight: bold;" type="text" plain
								@click="doFilter">&#8197;&#8197;&#8197;模型分析</el-button>
						</template>

					</el-popover>
					<br /><br /><br />
					<div>
						<p style="font-size:20px;font-weight: bold;">&#8197;&#8197;&#8197;模型性能(mAP)</p>
					</div> <br />

					<el-progress :percentage="percentage" :color="customColor"></el-progress><br />

					<div>
						<p style="font-size:20px;font-weight: bold;">&#8197;&#8197;&#8197;检测标签:狗</p>
					</div> <br />
					<el-main style="background:#f9fafd">
						<el-progress style="margin-left:200px;" type="circle" :percentage="percentage1">
							评估性能<br />{{percentage1}}%</el-progress>
						<el-progress style="margin-left:200px;" type="circle" :percentage="percentage2">
							检准率<br />{{percentage2}}%</el-progress>
						<el-progress style="margin-left:200px;" type="circle" :percentage="percentage3">
							检出率<br />{{percentage3}}%</el-progress>
							...
							<div style="margin-top: 20px;">
								<el-row type="flex" class="row-bg" justify="space-around">
									...
									<el-col :span="7">
										...
										<el-popover placement="top-start" title="模型性能（mAP）说明：" width="200"
											trigger="hover">
											<template #reference>
									...
									<el-col :span="8">
										...
										<el-input style="width: 25%;margin-right: 2%;" v-model="input"
				...
				<el-tab-pane :label="`校验详情`" name="second" style="margin-top: 10px">
